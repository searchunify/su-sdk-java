...
public class RestClient {
	 ...
	 * @return {@link String}
	 */
	public static String post(String context, Map<String, String> body, Map<String, String> headers, Map<String, String> parameters) {
		RequestManager manager = new RequestManager();
	 ...
	 * @return {@link String}
	 */
	public static String put(String context, Map<String, String> body, Map<String, String> headers, Map<String, String> parameters) {
		RequestManager manager = new RequestManager();
	 ...
	 * @return {@link String}
	 */
	public static String delete(String context, Map<String, String> body, Map<String, String> headers, Map<String, String> parameters) {
		RequestManager manager = new RequestManager();
